...
public class ProcedureModel extends RealmObject {
    @PrimaryKey
    private String id = UUID.randomUUID().toString();

    private DateModel procedureDate;
    ...
    public DateModel getProcedureDate() {
        return procedureDate;
    }

    public void setProcedureDate(DateModel procedureDate) {
