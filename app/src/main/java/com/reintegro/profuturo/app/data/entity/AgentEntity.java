...
public class AgentEntity {
    private DateEntity consarRegistrationDate;
    ...
    public DateEntity getConsarRegistrationDate() {
        return consarRegistrationDate;
    }

    public void setConsarRegistrationDate(DateEntity consarRegistrationDate) {
